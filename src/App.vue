...
function handleScroll() {
  ...
  // Defina a visibilidade do botão com base na posição do scroll
  showButton.value = scrollY > 0;

  // Defina a transparência da NavBar com base na posição do scroll
  isNavBarTransparent.value = scrollY < 50; // Altere o valor conforme necessário
}
