<template>
  <div class="project-container" id="projetos">
...
@media screen and (max-width: 1080px) {
  ...
  .project .project-title, .project.reverse .project-title {
    text-align: center;
  }

  .project .project-description, .project.reverse .project-description {
    text-align: center;
  }
}
